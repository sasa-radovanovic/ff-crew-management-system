...
/**
 * 
 * Rest endpoint to handle operations with Aiplanes/AirplaneTypes
 * 
...
public class AirplaneRestCtrl {
	...
	public ResponseEntity<AirplaneType> retrieveAirplaneTypes(@RequestBody AirplaneTypeRequest request) {
		...
		try {
			airplaneType = airplaneService.getAirplaneTypeByTypeAndMan(request.getType(), request.getManufacturer());
		} catch (Exception e) {
